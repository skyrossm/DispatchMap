$(function() {
	...
	var MapView = Backbone.View.extend({
		...
		initialize: function() {
			this.mapType = 'Atlas';
			this.mapDetails = { 'Atlas': '#0fa8d2', 'Satellite': '#143d6b', 'Road': '#1862ad', 'AtlasRoads': '#0fa8d2', 'SatelliteRoads': '#143d6b', 'RoadRoads': '#1862ad' };
			this.mapOptions = {
		...
		getTileImage: function(rawCoordinates, zoomLevel) {
            ...
            if(this.mapType == "AtlasRoads" || this.mapType == "RoadRoads" || this.mapType == "SatelliteRoads") {
                return 'tiles/' + this.mapType.toLowerCase() + '/' + zoomLevel + '/' + coord.x + '/' + coord.y + '.png';
            }
